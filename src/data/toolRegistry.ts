...
function addTool(
  ...
  const tool: ToolDefinition = { id, name, description, path, icon, category, keywords };
...
addTool(htmlCategory, 'html-minify', 'HTML Minifier', 'Remove unnecessary whitespace from HTML markup', '/html/minify', '🗜️', ['html', 'minify', 'compress', 'whitespace']);
...
addTool(htmlCategory, 'html-preview', 'HTML Previewer', 'Render HTML markup in a live sandboxed preview', '/html/preview', '👁️', ['html', 'preview', 'render', 'live']);
...
addTool(jsCategory, 'js-minify', 'JS Minifier', 'Minify JavaScript code by removing whitespace and comments', '/js/minify', '🗜️', ['javascript', 'js', 'minify', 'compress', 'uglify']);

// --- JSON Tools ---
const jsonCategory = createCategory('json', 'JSON Tools', '📋');
addTool(jsonCategory, 'json-escape', 'JSON Escape', 'Escape a string for safe embedding inside a JSON value', '/json/escape', '🔒', ['json', 'escape', 'string', 'quotes', 'backslash']);
...
addTool(jsonCategory, 'json-minify', 'JSON Minifier', 'Compact JSON by removing all unnecessary whitespace', '/json/minify', '🗜️', ['json', 'minify', 'compress', 'compact']);
...
addTool(jsonCategory, 'json-unescape', 'JSON Unescape', 'Unescape a JSON-escaped string back to its original form', '/json/unescape', '🔓', ['json', 'unescape', 'string', 'decode']);
...
addTool(markdownCategory, 'markdown-preview', 'Markdown Previewer', 'Render Markdown text as styled HTML in a live preview', '/markdown/preview', '👁️', ['markdown', 'preview', 'render', 'commonmark']);
